...
| **[meeting-standup](meeting-standup)** | A manager bot that runs your team's daily standup: it calls on everyone in the call by name, keeps time, remembers blockers across days and follows up until they're cleared, then posts a summary with action items to the chat. | Python |
